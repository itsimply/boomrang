...
?>
    ...
    <section class="spotlight bg-cover bg-size--cover" style="<?php echo $bg; ?>">
      ...
      <section class="slice slice-lg" data-delimiter="1">
        <div class="container">
          ...
          <div class="row cols-xs-space cols-sm-space cols-md-space">
            <div class="col-lg-4">
              <div class="card">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/team-1.jpg" class="card-img-top">
            ...
            <div class="col-lg-4">
              <div class="card">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/team-2.jpg" class="card-img-top">
                <div class="card-body text-center">
                  <h3 class="heading h5 mb-1">
            ...
            <div class="col-lg-4">
              <div class="card">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/team-3.jpg" class="card-img-top">
                <div class="card-body text-center">
                  <h3 class="heading h5 mb-1">
        ...
        <div class="container">
          <div class="row cols-xs-space cols-sm-space align-items-center">
            <div class="col-md-6 order-md-2 ml-lg-auto">
              <img src="<?php echo get_template_directory_uri(); ?>/images/prv/img-2-1000x900.jpg" class="img-center img-fluid rounded z-depth-3">
            </div>
        ...
        <div class="container">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card bg-lighter mb-lg mb-lg-0">
                    <div class="px-3">
                      <img class="card-img z-depth-2" src="<?php echo get_template_directory_uri(); ?>/images/prv/screen-homepage.jpg" style="margin-top: -30px;" alt="Homapage">
                    </div>
                    <div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="card bg-lighter mb-lg mb-lg-0">
                    <div class="px-3">
                      <img class="card-img z-depth-2" src="<?php echo get_template_directory_uri(); ?>/images/prv/screen-about.jpg" style="margin-top: -30px;" alt="Homapage">
                    </div>
                    <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card bg-lighter mb-lg mb-lg-0">
                <div class="px-3">
                  <img class="card-img z-depth-2" src="<?php echo get_template_directory_uri(); ?>/images/prv/screen-cover.jpg" style="margin-top: -30px;" alt="Homapage">
                </div>
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card bg-lighter mb-lg mb-lg-0">
                <div class="px-3">
                  <img class="card-img z-depth-2" src="<?php echo get_template_directory_uri(); ?>/images/prv/screen-contact.jpg" style="margin-top: -30px;" alt="Homapage">
                </div>
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card bg-lighter mb-lg mb-lg-0">
                <div class="px-3">
                  <img class="card-img z-depth-2" src="<?php echo get_template_directory_uri(); ?>/images/prv/screen-login.jpg" style="margin-top: -30px;" alt="Homapage">
                </div>
                <div class="card-body">
      ...
      <section class="slice slice-lg bg-cover bg-size--cover" style="background: url('<?php echo get_template_directory_uri(); ?>/images/backgrounds/img-2.jpg') center center;">
          ...
          <div class="row cols-xs-space cols-sm-space cols-md-space">
            <div class="col-lg-4">
              <div class="card border-0">
                <img class="rounded z-depth-3 img-fluid" src="<?php echo get_template_directory_uri(); ?>/images/prv/img-3-800x600.jpg" alt="Image description">
                <div class="pt-4">
            ...
            <div class="col-lg-4">
              <div class="card border-0">
                <img class="rounded z-depth-3 img-fluid" src="<?php echo get_template_directory_uri(); ?>/images/prv/img-2-800x600.jpg" alt="Image description">
                <div class="pt-4">
            ...
            <div class="col-lg-4">
              <div class="card border-0">
                <img class="rounded z-depth-3 img-fluid" src="<?php echo get_template_directory_uri(); ?>/images/prv/img-1-800x600.jpg" alt="Image description">
                <div class="pt-4">
          ...
          <div class="row cols-xs-space cols-sm-space cols-md-space">
            <div class="col-md-2 col-6">
              <div class="px-4 py-4 border rounded">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/client-1.png" class="img-fluid">
              </div>
            </div>
            <div class="col-md-2 col-6">
              <div class="px-4 py-4 border rounded">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/client-2.png" class="img-fluid">
              </div>
            </div>
            <div class="col-md-2 col-6">
              <div class="px-4 py-4 border rounded">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/client-3.png" class="img-fluid">
              </div>
            </div>
            <div class="col-md-2 col-6">
              <div class="px-4 py-4 border rounded">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/client-4.png" class="img-fluid">
              </div>
            </div>
            <div class="col-md-2 col-6">
              <div class="px-4 py-4 border rounded">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/client-5.png" class="img-fluid">
              </div>
            </div>
            <div class="col-md-2 col-6">
              <div class="px-4 py-4 border rounded">
                <img src="<?php echo get_template_directory_uri(); ?>/images/prv/client-6.png" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
