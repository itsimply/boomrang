...
get_header(); ?>
  ...
  <?php endif; ?>
    ...
    <section class="spotlight parallax bg-cover bg-size--cover" <?php echo $fullpage; ?>  style="<?php echo $bg; ?>">
            ...
            <div class="col-lg-10">
              ...
              <div class="row align-items-center mb-5">
                ...
                <div class="col-4 text-right">
                  <a href="#" class="btn btn-sm btn-primary">Open in Docs</a>
                </div>
              </div>
      ...
      <section class="slice slice-lg bg-tertiary bg-cover bg-size--contain" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/backgrounds/img-1.png'); background-position: center 10%;">
        <span class="mask bg-primary alpha-7"></span>
